...
Para la ui utilizare Imgui-docking con Opengl y GLFW.
Para la aplicación cli utilizare [CLI11](https://github.com/CLIUtils/CLI11).
Utilizare mi propia herramienta [core](https://github.com/enekocamara/core) para prototipar el projecto y despues la quitare.

## APLICACIÓN UI

Con Imgui-docking crear una pantalla con widgets que pueden ser reposicionadas y
cambiadas de tamaño.
